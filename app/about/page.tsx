    ...
    <section className="container py-12 md:py-16">
      ...
      <div className="mt-12 md:mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 mt-6 max-w-3xl">
          <div>
            <h3 className="text-lg font-medium text-neutral-800">{t('about.competencies.languages.title')}</h3>
            <p className="text-neutral-700 mt-1">
              {t('about.competencies.languages.p1')}
            </p>
          </div>
          <div>
            <h3 className="text-lg font-medium text-neutral-800">{t('about.competencies.styling.title')}</h3>
            <p className="text-neutral-700 mt-1">
              {t('about.competencies.styling.p1')}
            </p>
          </div>
          <div>
            <h3 className="text-lg font-medium text-neutral-800">{t('about.competencies.backend.title')}</h3>
            <p className="text-neutral-700 mt-1">
              {t('about.competencies.backend.p1')}
            </p>
          </div>
          <div>
            <h3 className="text-lg font--medium text-neutral-800">{t('about.competencies.design.title')}</h3>
            <p className="text-neutral-700 mt-1">
