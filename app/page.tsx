  ...
  return (
    <section className="container py-12 md:py-20 space-y-16">
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-[var(--brown)]">Our Certificates</h2>
        <p className="text-[var(--brown)]/80 max-w-2xl">
          We are committed to delivering high-quality web solutions. Our certifications from trusted platforms reflect our dedication to staying current with the latest industry standards.
        </p>
