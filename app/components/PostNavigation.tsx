  ...
  return (
    <nav className="my-12 flex flex-col sm:flex-row justify-between gap-8 border-t border-gray-200 dark:border-gray-700 pt-8">
      <div className="flex-1 text-left">
        {nextPost && (
          <Link href={`/blog/${nextPost.slug}`} className="group p-4 block border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
      ...
      <div className="flex-1 text-right">
        {prevPost && (
          <Link href={`/blog/${prevPost.slug}`} className="group p-4 block border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
